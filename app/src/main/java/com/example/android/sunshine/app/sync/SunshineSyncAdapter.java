...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        String cityId = SharedPreferenceHelper.getPreferredLocation(getContext());
        ...
        SharedPreferenceHelper.storePreferedWeatherForecast(forecast);

        notifyWeather(forecast);
    }


    private void notifyWeather(WeatherForecast forecast) {
        ...
        if (displayNotifications) {
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                //get today's weather
                WeatherDetail weatherDetail = forecast.getWeather().get(0);
                int weatherId = weatherDetail.getWeatherId();
                double high = weatherDetail.getHigh();
                double low = weatherDetail.getLow();
                String desc = weatherDetail.getDescription();
